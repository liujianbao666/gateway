...
//        System.out.println("连接数量："+m_processor.getConnectionDescriptors().countActiveConnections());
//        System.out.println("连接客户端ID："+m_processor.getConnectionDescriptors().getConnectedClientIds());
